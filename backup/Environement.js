...
export default class Environment {
    constructor() {
        ...
        //Light
        //Night
        /* this.setSunlight("#fff", 2, 32, 3, -11, "-1", true) 
        this.setSunlight("#fff", 2, -25, 4, -10, "-2", true) */

        //Day (render exposure 3)
        this.setSunlight("#fff", 10, 27, 3, -11, "-1", true) 
        //this.setSunlight("#fff", 0, -25, 4, -10, "-2", true)

        
        //this.setAmbiantLight("#fff", .3) 

        this.setSunlight("#fff", 2, 27, 3, -11, "-1", true)
